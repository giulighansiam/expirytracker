 ...
 */
 function vitcalc(){
	...
	var oldtime = expdate.getTime();
	var amttime = amt*86400;
	newdate.setTime(oldtime-amtTime);
	//document.getElementById("result").innerText="YYYY-MM-DD: "+expdate.getUTCFullYear()+"-"+(expdate.getUTCMonth()+1)+"-"+expdate.getUTCDate();
